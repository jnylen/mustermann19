...
module Mustermann19
  ...
  #   scanner = Mustermann19::StringScanner.new("here is our example string")
  #
  ...
  class StringScanner
    ...
    class ScanResult < DelegateClass(String)
      ...
      # @example
      #   require 'mustermann19/string_scanner'
      #   scanner = Mustermann19::StringScanner.new('foo/bar')
      ...
      #
      # @see Mustermann19::StringScanner#params
      # @see Mustermann19::StringScanner#[]
      #
    ...
    #   require 'mustermann19/string_scanner'
    #   scanner = Mustermann19::StringScanner.new("foo/bar/baz", type: :shell)
    #   scanner.scan('*')     # => "foo"
    ...
    # @return [Mustermann19::StringScanner] the scanner itself
    def reset
      @position = 0
      @params   = {}
      @history  = []
    ...
    # @return [Mustermann19::StringScanner::ScanResult, nil] the matched substring, nil if it didn't match
    ...
    # @return [Mustermann19::StringScanner::ScanResult, nil] the character, nil if at end of string
    def getch
    ...
    # @example
    #   require 'mustermann19/string_scanner'
    #   scanner = Mustermann19::StringScanner.new
    #   scanner << "foo"
    #   scanner.scan(/.+/) # => "foo"
    #
