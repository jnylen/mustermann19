...
module Mustermann19
  ...
  #
  # @example
  #   Mustermann19.new('/<foo>', type: :flask) === '/bar' # => true
  #
  ...
  class Flask < AST::Pattern
    ...
    # @see Mustermann19::Flask#register_converter
    class Converter
      ...
      #
      #   class MyPattern < Mustermann19::Flask
    ...
    #
    # If passed a block, it will be yielded to with a {Mustermann19::Flask::Converter}
    # instance and any arguments in the flask pattern.
    #
    # @example with simple object
    #   require 'mustermann19/flask'
    #
    #   MyPattern    = Class.new(Mustermann19::Flask)
