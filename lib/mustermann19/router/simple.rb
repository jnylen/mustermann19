...
module Mustermann19
  module Router
    ...
    #
    #   router = Mustermann19::Router::Simple.new do
    ...
    class Simple
      ...
      #   require 'mustermann/router/simple'
      #
      #   router = Mustermann19::Router::Simple.new(default: 42)
      ...
      #   require 'mustermann/router/simple'
      #
      #   router = Mustermann19::Router::Simple.new(type: :rails) do |r|
      #     r.on('/foo') { 'foo' }
      #     r.on('/bar') { 'bar' }
      #   end
      #
      ...
      # @return [Mustermann19::Router::Simple] new router instance
      ...
      #   require 'mustermann/router/simple'
      #
      #   router = Mustermann19::Router::Simple.new
      #   router.on(':a/:b') { 42 }
      #   router['foo/bar'] # => <#Proc:...>
      #   router['foo_bar'] # => nil
      #
      ...
      #   router.call('/foo') # => "foo"
      #
      # @param pattern [String, Mustermann19::Pattern] matcher
      ...
      def on(*patterns)
        ...
        patterns.each do |pattern|
          pattern = Mustermann19.new(pattern.to_str, @options.merge(options)) if pattern.respond_to? :to_str
          @map << [pattern, call]
        end
      end
