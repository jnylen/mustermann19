...
module Mustermann19
  ...
  #
  # @example
  #   Mustermann19.new('/:foo', type: :identity) === '/bar' # => false
  #
  ...
  class Identity < Pattern
    ...
    # Generates an AST so it's compatible with {Mustermann19::AST::Pattern}.
    # Not used internally by {Mustermann19::Identity}.
    # @!visibility private
    def to_ast
    ...
    #
    # This implementation does not use {Mustermann19::Expander} internally to save memory and
    # compilation time.
    #
