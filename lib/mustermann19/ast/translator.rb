  ...
  module AST
    ...
    class Translator
      ...
      class NodeTranslator < DelegateClass(Node)
        ...
        # @param node [Mustermann19::AST::Node, Object]
        # @param translator [Mustermann19::AST::Translator]
        #
        # @!visibility private
      ...
      #
      #   translator = Mustermann19::AST::Translator.create do
      #     translate(:node)  { [type, *t(payload)].flatten.compact }
      #     translate(Array)  { map { |e| t(e) } }
      #     translate(Object) { }
      #   end
      #
      #   ast = Mustermann19.new('/:name').to_ast
      ...
      raises Mustermann19::Error

      # @param [Mustermann19::AST::Node, Object] node to translate
