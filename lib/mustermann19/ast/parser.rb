...
module Mustermann19
  ...
  module AST
    ...
    class Parser
      ...
      # @return [Mustermann19::AST::Node] parse tree for string
      # @!visibility private
      ...
      #
      # @see Mustermann19::Rails
      # @see Mustermann19::Sinatra
      # @see Mustermann19::Template
      # @!visibility private
      ...
      # @return [Mustermann19::AST::Node] the node
      # @!visibility private
      ...
      # @return [Mustermann19::AST::Node] next element
      # @!visibility private
      def read
        start  = pos
        char   = getch
      ...
      # @return [Mustermann19::AST::Node] the node passed as third argument
      # @!visibility private
      ...
      # @param [Mustermann19::AST::Node] element node without suffix
      # @return [Mustermann19::AST::Node] node with suffix
      # @!visibility private
      ...
      # @raise [Mustermann19::ParseError] if expectation wasn't met
      # @!visibility private
      ...
      # @raise [Mustermann19::ParseError, Exception]
      # @!visibility private
