module Mustermann19
  ...
  module AST
    ...
    class Node
      ...
      # @!visibility private
      class Capture < Node
        # @see Mustermann19::AST::Compiler::Capture#default
        # @!visibility private
        attr_accessor :constraint

        # @see Mustermann19::AST::Compiler::Capture#qualified
        # @!visibility private
        attr_accessor :qualifier

        # @see Mustermann19::AST::Pattern#map_param
        # @!visibility private
        attr_accessor :convert

        # @see Mustermann19::AST::Node#parse
        # @!visibility private
        def parse
          self.payload ||= ""
          super
      ...
      # @!visibility private
      class Splat < Capture
        # @see Mustermann19::AST::Node::Capture#name
        # @!visibility private
        def name
          "splat"
        end
