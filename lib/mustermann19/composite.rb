module Mustermann19
  ...
  class Composite < Pattern
    ...
    # @see Mustermann19::Pattern.supported?
    def self.supported?(option, options = {})
      return true if super
      options[:type] and Mustermann19[options[:type]].supported?(option, options)
    end

    # @return [Mustermann19::Pattern] a new composite pattern
    ...
    # @see Mustermann19::Pattern#params
    def params(string)
      with_matching(string, :params)
    end

    # @see Mustermann19::Pattern#match
    def match(string)
    ...
    def expand(behavior = nil, values = {})
      ...
      @expander ||= Mustermann19::Expander.new(*patterns)
    ...
    def patterns_from(pattern, options = nil)
      ...
      [options ? Mustermann19.new(pattern, options) : pattern]
    end
